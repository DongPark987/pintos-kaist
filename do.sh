...
# pintos --gdb -v -k -T 60 -m 20   --fs-disk=10 -p tests/userprog/args-none:args-none --swap-disk=4 -- -q   -f run args-none
# pintos --gdb --fs-disk=10 -p tests/userprog/args-none:args-none --swap-disk=4 -- -q   -f run args-none
# pintos --fs-disk=10 -p tests/userprog/args-many:args-many --swap-disk=4 -- -q   -f run args-many
# pintos --fs-disk=10 -p tests/userprog/fork-onece:fork-once --swap-disk=4 -- -q   -f run fork-once
